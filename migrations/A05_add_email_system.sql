...
('schema_version', 'A05', 'Versão atual do schema com sistema de e-mail'),
('migration_A05_applied_at', strftime('%s', 'now') || '000', 'Timestamp da aplicação da migração A05'),
...
('migration_A05_changelog', 
 ...
 'Log de mudanças da migração A05');
